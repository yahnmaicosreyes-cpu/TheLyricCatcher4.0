/**
 * @fileoverview Built-in song library and localStorage key constants.
 *
 * HOW TO ADD A BUILT-IN SONG
 * ──────────────────────────
 * Append a new object to the BUILT_IN array below. Required fields:
 *
 *   id      – Unique string. Use the next sequential "builtin_N" value.
 *   title   – Song title (string).
 *   artist  – Artist or artists (string).
 *   album   – Album name (string) or null.
 *   lyrics  – Full lyrics (string). Two supported formats:
 *               • Plain text — section labels appear as-is in the song view.
 *               • Bracket markers — use [Verse 1], [Chorus], [Bridge], etc.
 *                 These are parsed and rendered with styled section headers.
 *
 * HOW TO REMOVE A BUILT-IN SONG
 * ──────────────────────────────
 * Delete its entry from BUILT_IN. Users who previously deleted or edited
 * the song via the UI will have stale localStorage entries for that ID,
 * but those are harmless and will never be read.
 */
...
/** Key for the array of built-in song IDs the user has deleted. */
const DELETED_KEY = 'lyric_catcher_deleted_ids';

/** Key for the map of user edits applied to built-in songs, keyed by song ID. */
const OVERRIDES_KEY = 'lyric_catcher_overrides';
...
const BUILT_IN = [
  { id: 'builtin_1', title: `No One Like The Lord (Live)`, artist: `Bethel Music, Jenn Johnson`, album: null, lyrics: `Verse
...
There’s no one like the Lord
There’s no one like the Lord` },
  { id: 'builtin_2', title: `Abandoned`, artist: `Benjamin William Hastings, Brandon Lake`, album: null, lyrics: `Verse 1
...
I know you’ll never leave me abandoned
I surrender all
...
Don’t care who sees me abandoned
Oh I surrender` },
  { id: 'builtin_3', title: `All I Ever Wanted(Give Me Jesus)`, artist: `Red Rocks Worship`, album: null, lyrics: `Verse 1
...
Ohh
Oh give me Jesus ohh

Verse 2

Countless is Your compassion
It’s met me in
The darkest days of my life
And Your grace
I can’t outrun it
I’ve never for a second
Left Your sight
...
Take these chains I lay them down
Unashamed I’m breaking out
My sin was great Your grace abounds
You’re faithful then and You’re faithful now
Take these chains I lay them down
Unashamed I’m breaking out
My sin was great Your grace abounds
You’re faithful then and You’re faithful now
...
Just Jesus
Just You Jesus` },
  { id: 'builtin_4', title: `Be Crowned`, artist: `Jesus Culture`, album: null, lyrics: `[Verse 1]
...
Oh, the majesty
Oh, the glory of our King` },
  { id: 'builtin_5', title: `Christ and Christ Crucified`, artist: `Lindy Cofer, Circuit Rider Music, Mitch Wong`, album: null, lyrics: `Verse 1
...
We sing Christ and Christ crucified
Hallelujah hallelujah` },
  { id: 'builtin_6', title: `Come and Behold`, artist: `UPPERROOM`, album: null, lyrics: `Verse 1

With all I am
I long to see Your beauty
Just one glance
Can change my whole perspective
I'm ready

Pre Chorus

To see You see You rightly
...
Holy Spirit reveal the Son to me
I only know what You show me

Refrain

Holy Spirit reveal the Son to us
We only know what You show us

Bridge 1

And come and behold Him
...
I love to behold Him
He is so fascinating
I love to behold Him
I get lost in His majesty
I love to behold Him
...
I love to behold You
You are so fascinating
I love to behold You
I get lost every time I see You Lord
I love to behold You
I can keep my eyes all of You Lord
I love to behold You
I love to behold You
...
I love to behold You
Cause You are so fascinating
I love to behold You
I get lost in Your majesty
I love to behold You
You are so captivating
I love to behold You
I love to behold You` },
  { id: 'builtin_7', title: `Crowns Down`, artist: `Gateway Worship, Josh Baldwin`, album: null, lyrics: `Verse 1
...
Holy, holy, holy
Holy is the Lord` },
  { id: 'builtin_8', title: `Faithful Now`, artist: `Vertical Worship`, album: null, lyrics: `Verse 1
...
You were faithful then
You'll be faithful now` },
  { id: 'builtin_9', title: `Fountains`, artist: `Josh Baldwin`, album: null, lyrics: `Verse 1
...
The Fount that won’t run dry
Nothing satisfies like You do` },
  { id: 'builtin_10', title: `Glorify Thy Name / Let It Rain`, artist: `Jesus Culture, KXC & Amy Dolley`, album: null, lyrics: `Father, we love You
...
Yes, we glorify Your name
Glorify Your name in all the earth
We glorify Your name
Glorify Your name
Glorify Your name in all the earth` },
  { id: 'builtin_11', title: `Glory, Honor, Power`, artist: `Influence Music, Melody Noel, Matt Gilman`, album: null, lyrics: `Verse 1
...
Glory and honor
And power forever` },
  { id: 'builtin_12', title: `Gratitude`, artist: `Brandon Lake`, album: null, lyrics: `Verse 1
...
Except for a heart singing
Hallelujah hallelujah` },
  { id: 'builtin_13', title: `His Eye is On the Sparrow`, artist: `Civilla D. Martin, 1905`, album: null, lyrics: `Verse 1
...
For His eye is on the sparrow, 
And I know He watches me.` },
  { id: 'builtin_14', title: `Holy Forever`, artist: `Bethel Music, Jenn Johnson, CeCe Winans`, album: null, lyrics: `verse - 

A thousand generations
Are falling down in worship
...
'Cause Your name is the highest
...
Oh, Jesus, ′cause Your name is the highest
And Your name is the greatest
Your name, it stands above them all
Oh, above all thrones and dominions (yeah)
And all powers and positions
Your name, it stands above them all
...
Holy forever
And the angels cry, holy
All creation cries, holy (c′mon)
You are lifted high, holy (yeah, whoa)
Holy forever (forever, forever)
All the people sing, come on, holy
To the King of kings, holy
You will always be, holy
Holy forever
(It'll never stop)
...
And the angels cry, holy (oh, holy)
All creation cries
You are wonderful (holy)
Oh, yeah
Yeah, yeah, yeah (You are lifted high)
Keep crying, You′ll always be (holy)
Yeah, oh, simply wonderful (holy forever)
Wonderful (wonderful)
I will always cry, holy (hear Your people sing, holy)
I'm gonna keep on lifting You higher (to the King of kings, holy)
I′m gonna keep on lifting You higher
Hey, hey (You will always be, holy)
Holy forever, yeah

bridge

Holy, holy (You will always be, holy)
Holy, holy (holy forever)
Keeps going, it keeps going
Always be, holy, holy (You will always be, holy, holy forever)
I'm gonna keep crying out
′Cause You will always be (holy, holy forever)
I'm gonna continue to give You all my heart
'Cause You will always be (holy, holy forever)

outro

I will never stop praising Your name
I will never stop lifting You
′Cause You will always be (holy, holy forever)
I′m gonna stand right in Your presence
'Cause You will always be (holy, holy forever)
I′m not gonna live for anyone else
Everything I have is Yours
'Cause You will always be (holy, holy forever)
God, I love You
′Cause You will always be (holy, holy forever)
Holy, holy, holy, holy
Worthy, worthy, worthy, worthy (You will always be holy)
Lovely, lovely (holy forever)
We're gonna join in with the angels and sing
′Cause You will always be
Holy, holy, forever` },
  { id: 'builtin_15', title: `Holy God, we praise Thy Name`, artist: `Author (attributed to): Ignace Franz; Translator: Clarence A. Walworth`, album: null, lyrics: `Representative Text
...
Never, Lord, abandon me.` },
  { id: 'builtin_17', title: `Jesus You Alone`, artist: `Highlands Worship`, album: null, lyrics: `Verse 1
...
Jesus You alone` },
  { id: 'builtin_18', title: `Keep My Heart Tender`, artist: `UPPERROOM`, album: null, lyrics: `Verse 1
...
Let my life be
Praise to You` },
  { id: 'builtin_19', title: `King Jesus`, artist: `Jesus Culture, Derek Johnson (Worship)`, album: null, lyrics: `Verse 1

You took the power of the grave forever
Bearing all our sin and shame redeemer
...
Made perfect by Your blood
The ransom for us all King Jesus
Worthy is the Lord of Lords
The bright and morning star
The hope for all the world King Jesus

Verse 2

Your wounding was for our transgression
Your body became crushed and broken
Oh but the King of Glory rose
Now we shout out Your praise
...
We come to bow down and worship
...
The bright and morning star
The hope for all the world King Jesus` },
  { id: 'builtin_20', title: `Low`, artist: `Kory Miller`, album: null, lyrics: `Verse 1

I don't wanna profit off
Your presence
I don't wanna build
What You'd tear down
I don't wanna bring
A half surrender
I just wanna be
The first to bow
...
All I can say is
You are holy` },
  { id: 'builtin_21', title: `Made For More`, artist: `Josh Baldwin`, album: null, lyrics: `Verse 1
...
I know I am Yours
And I was made for more` },
  { id: 'builtin_22', title: `More Like Jesus`, artist: `Passion, Kristian Stanfill`, album: null, lyrics: `Verse 1
...
Yes all of You is all I need
Take ev'rything` },
  { id: 'builtin_23', title: `My Hearts Wants You`, artist: `Mountain People Worship`, album: null, lyrics: `[Verse]
I wake up in the dead of night
With my heart calling Yours
Jesus, Jesus
...
Even in my silence I'm singing
Oh Jesus, Jеsus
Even in my trials I'm praising
Even through my fires I'm gazing
At Jеsus, Jesus` },
  { id: 'builtin_24', title: `My Help`, artist: `Gateway Worship, Josh Baldwin`, album: null, lyrics: `Verse 1
...
My God will always make a way` },
  { id: 'builtin_25', title: `My Vision by`, artist: `Jesus Culture, Lindsey Arcaro`, album: null, lyrics: `[Verse 1]
...
[Chorus]
Lord God, most worthy of honor and praise
You are my portion now and always
You are my vision, my greatest reward
Beautiful Savior, my heart's one desire

[Instrumental]
Oh, You're my desire and my delight, Jesus
Who else is like You?

[Verse 3]
Riches I heed not, nor vain, еmpty praise
Thou mine inheritancе, now and always
Thou and Thou only first in my heart
High King of heaven, my treasure Thou art (Oh, He's worthy)` },
  { id: 'builtin_26', title: `O Come to the Alter`, artist: `Elevation Worship`, album: null, lyrics: `Verse 1
...
Tell the world of the treasure you’ve found` },
  { id: 'builtin_27', title: `On The Alter`, artist: `UPPERROOM`, album: null, lyrics: `Verse 1
...
I wanna be a laid-down lover
All my life` },
  { id: 'builtin_28', title: `Open The Eyes Of MY Heart`, artist: `7 Hills Worship`, album: null, lyrics: `[Chorus]
...
Shinin’ in the light of Your glory
Pour out Your power and love
As we sing holy, holy, holy (Holy)
...
Holy, holy, holy
I want to see you` },
  { id: 'builtin_29', title: `Our God Reigns`, artist: `Gather Worship, Sinach, Martin Smith`, album: null, lyrics: `Verse 1
...
The only one who saves
Forever Jesus reigns` },
  { id: 'builtin_30', title: `Prince Of Peace`, artist: `Josh Baldwin`, album: null, lyrics: `Verse 1
...
I just wanna leave them all behind
...
Come and be
My Prince of Peace` },
  { id: 'builtin_31', title: `Reign Above It All`, artist: `Bethel Music, Paul McClure`, album: null, lyrics: `Verse 1
...
There is no higher name
Jesus You reign above it all` },
  { id: 'builtin_32', title: `Send The Fire`, artist: `Jesus Culture, Gas Street Music, Tim Hughes`, album: null, lyrics: `Verse 1
...
We need a move of Heaven
The glory of Your presence` },
  { id: 'builtin_33', title: `So Much`, artist: `Life.Church Worship`, album: null, lyrics: `[Verse 1]
There is a love so good
It never, ever ends
There is a joy with every morning new
A solid rock that stands
When all around me shakes
Jesus, I find, I find it all in You
...
It holds me through the storm
There is a faith that makes the mountains move
A name so great
A name not еven death can stand against
Jesus, I find (Comе on) I find it all in You, sing
...
It's so easy to praise You, Lord
I've got so much, so much to be thankful for` },
  { id: 'builtin_34', title: `Thank You Jesus`, artist: `Josh Baldwin`, album: null, lyrics: `Verse 1
...
I enter the gates of the Lord
With thanksgiving
I enter the courts
Of the Lord with praise
I enter the gates of the Lord
With thanksgiving
I enter the courts
Of the Lord with praise
...
Woah thank You
Woah thank You` },
  { id: 'builtin_35', title: `The Blood`, artist: `Bethel Music, David Funk`, album: null, lyrics: `Verse 1
...
I know it was the blood
Could have only been the blood` },
  { id: 'builtin_36', title: `Time and Time Again`, artist: `Bethel Music & Josh Baldwin`, album: null, lyrics: `Verse 1
...
‘Cause there’s nothing that You won’t restore
As the waters rise I’ll lift up my eyes
To where my help’s coming from

Tag

‘Cause You’re where
My help’s coming from

Chorus

Cause You’ll come through now like
You did back then
Time and time and time again
Almighty fortress my defense
Time and time and time again
...
I’m standing on Your goodness God
...
Time and time and time again` },
  { id: 'builtin_37', title: `10,000 Reasons (Bless The Lord)`, artist: `Matt Redman`, album: null, lyrics: `[Chorus]
...
I'll worship Your holy name
Bless you, Lord` },
  { id: 'builtin_38', title: `Amazing Grace (My Chains Are Gone)`, artist: `Chris Tomlin (Newton/Tomlin)`, album: null, lyrics: `[Verse 1]
...
And like a flood His mercy reigns
Unending love, amazing grace` },
  { id: 'builtin_39', title: `Build My Life`, artist: `Housefires`, album: null, lyrics: `[Verse 1]
...
Lead me in Your love` },
  { id: 'builtin_40', title: `Consuming Fire`, artist: `Tim Hughes`, album: null, lyrics: `[Intro]
...
Leave us abandoned to Your praise` },
  { id: 'builtin_41', title: `Cornerstone`, artist: `Hillsong Worship`, album: null, lyrics: `[Verse 1]
...
Through the storm, He is Lord
Lord of all` },
  { id: 'builtin_42', title: `Goodness of God`, artist: `Bethel Music / Jenn Johnson`, album: null, lyrics: `Verse 1
I love You, Lord
...
Your goodness is running after, it's running after me` },
  { id: 'builtin_43', title: `Graves Into Gardens`, artist: `Elevation Worship / Brandon Lake`, album: null, lyrics: `[Verse 1]
...
Nothing is better than You
Oh, there's nothing better than You
There's nothing, no, better than you
Lord, there's nothing
Nothing is better than You` },
  { id: 'builtin_44', title: `Great Are You Lord`, artist: `All Sons & Daughters`, album: null, lyrics: `[Verse 1]
...
It's Your breath in our lungs
So we pour out our praise to You only` },
  { id: 'builtin_45', title: `Holy Spirit`, artist: `Bryan & Katie Torwalt`, album: null, lyrics: `[Verse 1]
...
You're our living hope
Your presence, Lord` },
  { id: 'builtin_46', title: `How Great Is Our God`, artist: `Chris Tomlin`, album: null, lyrics: `[Verse 1]
...
How great is our God, and all will see
How great, how great is our God` },
  { id: 'builtin_47', title: `In Christ Alone`, artist: `Keith & Kristyn Getty`, album: null, lyrics: `[Verse 1]
...
Bought with the precious blood of Christ` },
  { id: 'builtin_48', title: `Living Hope`, artist: `Phil Wickham`, album: null, lyrics: `[Verse 1]
...
There's salvation in Your name
Jesus Christ, my living hope` },
  { id: 'builtin_49', title: `Lord I Need You`, artist: `Matt Maher`, album: null, lyrics: `[Verse 1]
...
Jesus, You're my hope and stay` },
  { id: 'builtin_50', title: `Mighty To Save`, artist: `Hillsong Worship`, album: null, lyrics: `[Verse 1]
...
He rose and conquered the grave
Jesus conquered the grave` },
  { id: 'builtin_51', title: `O Come To The Altar`, artist: `Elevation Worship`, album: null, lyrics: `[Verse 1]
Are you hurting and broken within?
Overwhelmed by the weight of your sin?
Jesus is calling
Have you come to the end of yourself?
...
Forgiveness was bought with
The precious blood of Jesus Christ` },
  { id: 'builtin_52', title: `Oceans (Where Feet May Fail)`, artist: `Hillsong UNITED`, album: null, lyrics: `[Verse 1]
...
Oh, Jesus, You're my God` },
  { id: 'builtin_53', title: `Reckless Love`, artist: `Cory Asbury`, album: null, lyrics: `[Verse 1]
...
There's no wall You won't kick down
Lie You won't tear down, coming after me` },
  { id: 'builtin_54', title: `This Is Amazing Grace`, artist: `Phil Wickham`, album: null, lyrics: `[Intro]
Oh-oh-oh-oh-oh
Oh-oh-oh, oh, oh
Oh-oh-oh-oh-oh
Oh-oh-oh, oh, oh
...
All that You've done for me` },
  { id: 'builtin_55', title: `Way Maker`, artist: `Sinach`, album: null, lyrics: `[Verse 1]
...
I worship You, I worship You` },
  { id: 'builtin_56', title: `What A Beautiful Name`, artist: `Hillsong Worship`, album: null, lyrics: `[Verse 1]
...
What a wonderful name it is
The name of Jesus` },
  { id: 'builtin_57', title: `Trust You`, artist: `7 Hills Worship`, album: null, lyrics: `[Verse 1]
...
I don't need to know it all
To know I want You` },
  { id: 'builtin_58', title: `We Crown You`, artist: `Jeremy Riddle`, album: null, lyrics: `Verse 1
...
For the merciful wonderful majesty
Of Your love
...
We crown You
We fall face down we worship
We all cry out
You are worthy God
You are worthy God` },
  { id: 'builtin_59', title: `You Are Our God`, artist: `Josh Baldwin`, album: null, lyrics: `1 Verse:
We give thanks to You, Lord
Your love endures forever
Your Grace is an open door
Your mercy is our treasure
When we were in darkness You came
Your light, it fills our hearts
So let this house be a house of praise
...
Our salvation, our deliverance

2 Verse:
We give thanks to You, Lord
Your Spirit is within us
Now and forever morе
We’re carrying Your presеnce
You said we’d do greater things
You’re with us every hour
So fill this house with faith
And resurrection power` },
  { id: 'builtin_60', title: `You Saved Me`, artist: `UPPERROOM, Abbie Gamboa`, album: null, lyrics: `Chorus
...
Now I will never
Leave Your love` },
  { id: 'builtin_61', title: `The Next Rap God 2`, artist: `Dax`, album: null, lyrics: `[Verse 1]
...
You get eclipsed, and then I star in the movie
Where the underdog (LexNour) leaves the wholе game straight confused
...
Full of songs from the depths of my heart, and these people didn't appreciate it` },
  { id: 'builtin_62', title: `In The Room`, artist: `Maverick City Music, Tasha Cobbs Leonard`, album: null, lyrics: `VERSE 1
I’m not forsaken
Never alone
The God of Heaven
Calls me His own
...
Right here in His safety` },
  { id: 'builtin_63', title: `The Hand That Keeps Holding Me`, artist: `Tasha Cobbs Leonard`, album: null, lyrics: `[Verse 1: Tasha Cobbs]
I feel Your love here in the valley
Don't know what's been happenin'
But I've seen You move
No, this isn't new
Oh, it's been rough, the storm has been raging
...
You promised You will never let me go
So I'll just keep holdin' the hand that keeps holdin' me

[Verse 2: Tasha Cobbs, Tasha Cobbs & Choir]
I looked away but You stared right at me
No, You're not mad at me
This is a love I don't understand
I tried to run, was caught by Your mercy
No, You wouldn't hurt me
Your grace, it will reach wherever I am

[Chorus: Tasha Cobbs & Choir]
My Shepherd, lead me
I'll go, I'll follow
Don't leave me alone
You promised You will never let me go
...
Oh-oh
You keep on holdin' me
Never let me go

[Bridge: Tasha Cobbs, Choir]
Your hand is stronger than my past
Your heart is bigger than my sin
Your eyes are on my every move
Your plan is better, I'll follow You
Your hand is stronger than my past (Your, oh, it's stronger than my past)
Your heart is bigger than my sin (Your heart, oh, it's so much bigger than my sin)
Your eyes are on my every move (Your eyes are on my—, you're lookin' at every move)
Your plan is better, I'll follow You (Your plan, so much better, I'll follow, Your—)
Your hand is stronger than my past (Yes, it is, it is stronger than our past)
Your heart is bigger than my sin (Your heart is bigger, threw my sins in the sea of forgetfulness)
Your eyes are on my every move (Your eyes are on me, You never take Your eyes off me)
Your plan is better, I'll follow You (Your—, I'll follow You)
Your plan is better, I'll follow You (Yes, I will, I have decided)
Your plan is better (I'm gonna follow Jesus, ayy)

[Chorus: Tasha Cobbs & Choir]
My Shepherd, lead me
I'll go, I'll follow
Don't leave me alone
You promised You will never let me go, oh
So I'll just keep holdin' the hand that keeps holdin'
Oh, I'll just keep holdin' the hand that keeps holdin' me` },
  { id: 'builtin_64', title: `Holy`, artist: `Tasha Cobbs Leonard`, album: null, lyrics: `Verse 1
You were
You are
Evermore shall be
Living word
...
There is none beside You, God` },
  { id: 'builtin_65', title: `Fill Me Up (Live)`, artist: `Tasha Cobbs Leonard`, album: null, lyrics: `[Pre-Chorus]
...
Fill me up, God
Fill me up` },
  { id: 'builtin_66', title: `Asereje`, artist: `Las Ketchup`, album: null, lyrics: `[Verso 1]
...
De jebe tu de jebere sebiunouva
Majabi an de bugui an de buididipí` },
  { id: 'builtin_67', title: `Afro Blue`, artist: `Robert Glasper feat. Erykah Badu`, album: null, lyrics: `Verse]
...
Shades of delight cocoa hue
Rich as the night, afro blue` },
  { id: 'builtin_68', title: `Free`, artist: `Little Simz`, album: null, lyrics: `[Refrain]
...
Shout my brothers locked in the can tryna get free
There's a war outside, pray the people go free` },
  { id: 'builtin_69', title: `Lion`, artist: `Little Simz`, album: null, lyrics: `[Intro: Obongjayar]
...
That's my superpower` },
  { id: 'builtin_70', title: `Chanel`, artist: `Tyla`, album: null, lyrics: `[Intro: Tyla & Dougie F]
Put her in Chanel
Put her in Chanel
...
How you say you love me? You ain't put me in Chanel
Say you love me, put me in Chanel` },
  { id: 'builtin_71', title: `Trauma Queen`, artist: `Devin Malik`, album: null, lyrics: `[Chorus]
Love can make you want me for sure
Love can make you want me for sure
Love can make you want me for sure
Love can make you want me for sure

[Verse]
Bounce on it, love it when she bounce on it
Said she got a CPM, she got a house from it
I said "I'm on my way", I'm playin' loud music
She play Beyoncé, told me it was house music
The vibe was goin' great 'til we saw the call
It's my ex on the phone, said she want it all
She said that she's gon' beat my ass if I don't cut her off
I'm in the studio, workin' on another song
I'm in the studio, givin' up another song
There's some whores, in the house that don't get along
'Cause women insecure about women
She had her mama and her best friend in them— (Mentions)
And there's still assholes like me that tell 'em different
I'm just a hypocrite, beggin' for attention, now she
Bipolar, bisexual and—
Hit from the back and she puts back in too much inches (Too much inches)
...
Love can make you want me for sure
Love can make you want me for sure` },
  { id: 'builtin_72', title: `Come To Think`, artist: `Gabrielle Current`, album: null, lyrics: `[Verse 1: Gabrielle Current]
...
[Verse 2: FINNEAS & Gabrielle Current]
...
[Bridge: Gabrielle Current & FINNEAS]
Watch my colors run
Watch 'em run
Watch 'em run
...
Oh, I'm just telling the truth
Just tell me the truth` },
  { id: 'builtin_73', title: `Autumn in New York`, artist: `Lena Horne`, album: null, lyrics: `(Verse)
Autumn in New York
...
It's good to live it again.` },
  { id: 'builtin_74', title: `Where Are You?`, artist: `Zap Mama`, album: null, lyrics: `I know nothing yet about him
...
Are you far, are you nearby where are you
Are you far, are you nearby where are you` },
  { id: 'builtin_75', title: `Why Love`, artist: `Asake`, album: null, lyrics: `[Intro]
...
Abia, Umuahia
Okay, dey play` },
  { id: 'builtin_76', title: `Yeern 101`, artist: `Schoolboy Q`, album: null, lyrics: `[Verse 1]
...
Like damn, Wop, how I get a bitch like yeern?` },
  { id: 'builtin_77', title: `Blueslides`, artist: `Schoolboy Q`, album: null, lyrics: `[Intro: ScHoolboy Q & Lauren Santi]
Lover of mine
...
Sweeter than the ocean
Ooh-ooh` },
  { id: 'builtin_78', title: `Freshie`, artist: `Kid Cudi`, album: null, lyrics: `[Intro: DJ Drama & Kid Cudi]
Yo, ayy, ayy, yo
...
[Chorus]
Now I'm fresh in the night and I'm doin' shrooms (Ah, ah)
Can't tell a nigga nothin' when I'm in the room (Ah, ah)
See I ball, fuck 'em all, do you get it dude? (Ah, ah)
And I beat the oochie up, get up in her womb (Ah, ah)
It's a new damn day, film comin' soon (Ah, ah)
And they call for a nigga, I'm controllin' the minions (Ah, ah)
Lost in the sinnin', while we rage and we winnin' (Ah, ah)
Wait, wait, hol'-hol'-hol'-hold on, wait a minute (Ah, ah)

[Verse: Kid Cudi, Dot Da Genius & DJ Drama]
...
All my niggas feel me, can't save 'em, boy (Yeah)
Can't blame 'em, when I'm doin' what I'm doin' (Yeah)
I don't give a fuck 'bout a punk talkin' shit (Yeah)
I'm the illest nigga in it, been the trilla from the top (Woo)
We ain't hear the shots, when I step up I'mma walk
I'm the realest nigga rippin' 'cause a nigga say so (Yeah, yeah)
Man, some dumb fucks never get it (Yeah)
Dumb fucks stuck, never livin' (Yeah)
Ridin', pullin' up, it begins, loud trunk on a bitch
Bump, bump, I'm slump, keep it hidden (Uh)
If she wanna leave, I let the girl lead (Go)
Nigga feel the pain but I bleed what I bleed (Yeah)
Yeah, I'm just a WZRD, boy, tricks up my sleeve (Yeah)
Yeah, I rep the double O even when I leave
Yeah, I'm just the cleanest motherfucker from the C (Uh)
Never ever seen a nigga quite like me (Uh)
Take it on the roof when the vibe too low (Yeah)
Gather all the blunts, burn 'em down in a row (Phew)
And I'm all dazed, eyes neon red (Uh)
...
I'm winnin', ain't I? Been in it, make her cream, don't gotta say I wanna (Ah)
When I pull up in the booth, get the scoop, uh-huh (Woo)
This the win on, get on down (Ah)
Rollin' with my nigga Dot (Dot), and we ragin' out (Hah)
With a bitch with a couple nots (Hah)
And we know when we got 'em hot (Hah)
Sucker niggas think it's love, better tell that boy, "No it's not" (Hah)
Can't stop Cudi, no you fool (Woo)
Been doin' what you cannot do, and I'm pretty too (Woo)
...
Never been the type to end it, I'm fuckin' spinnin' (Tsh)
I'm pour another shot of liquor, and then I did it (Uh-huh)
Askin' the Lord, the Lord, too blessed to fall
Now prai-prai-prai-praise you God
I'm straight drippin' (Yeah), there's the boy
Keep my guards up, back, back off me boy
They say I'm sickened (Sickened)
Just a nigga livin' with some stress (Stress)
Often smokin' layin' back (Back), ripped (Ripped)
...
Dot, what up?
You know
Maybe if you made changes in your life, think positively
...
Lost in the sinnin', while we rage and we winnin' (Ah, ah)
Wait, wait, hol'-hol'-hol'-hold on, wait a minute (Ah, ah)` },
  { id: 'builtin_79', title: `No Trespassing`, artist: `A$AP Rocky`, album: null, lyrics: `[Intro]
...
Bought the projects, now crib lookin' like George Jetson
...
Boy, you seen where I shop, you need a membership
...
Goin' to church on Sunday (Ah), all the sistas on you
...
Bro, shut it down, bro, shut it down
Nigga's talkin' reckless, must be out his mind
X him off the checklist (Dead), read between the line
I might move to Texas, ride 'round with my weapons
If they disrespectin', I'ma shut 'em down` },
  { id: 'builtin_80', title: `Avoid Things`, artist: `Tems`, album: null, lyrics: `[Verse 1]
...
Ooh-ooh, ooh-ooh, ooh, ooh
Ooh-ooh, ooh-ooh, ooh, ooh` },
  { id: 'builtin_81', title: `Kiwi`, artist: `Bleu Toucan`, album: null, lyrics: `All night long
All night long
All night long
All night long

In the world when I can sing all night long
In the world when I can sing all night long
In the world when I can sing all night long
In the world when I can sing all night long
In the world when I can sing all night long
...
In the world when I can sing-
In the world when I can sing- (sing, sing, sing...)

All night long
All night long (ah ah ahhhh)` },
  { id: 'builtin_82', title: `Petite Etoile`, artist: `Polo & Pan (feat. Beth Ditto)`, album: null, lyrics: `Going deep
...
Anymore
Anymore` },
  { id: 'builtin_83', title: `Amawaza`, artist: `Boohle`, album: null, lyrics: `[Intro: FOCALISTIC & Boohle]
Ase trap tse ke pina tsa ko kasi
Ay Busta ung'ketsang?
Mhhh, ses'fike ngama waza waza waa, hayaya
Eh, yey
Amawazawaza
Amawazawaza
Amawazawaza, mhhh, ay yeah

[: Boohle]
Uyang'bona mara awukwazi ukuthinta
I-ghost mfana i-ghost
Bheka manje, sifike ngama waza waza
Sivulelapho sani sivulelapho sani
Sipheth' intshiza sivulelapho sani

Iguwee
Ehh bathi mntana wako mkovishi
Sphethi intshiza sivulelapho sani

Sbu can i speak
Can i say
Remitise
Remiti sbu
Can i speak, can i say
Remitise
Remiti sbu
Can i speak, can i say
Remitise
Remiti sbu ( ishuu )
Can i speak, (nantsoke ) can i say ( bathini )
Remitise

[Verse]
Ayy Busta ung ketsang
Engithi ng'khule nabantu badala badlu mtlabathi
Umama uqedu thum' umbali ayothenga inkomasi
Ekhaya kunase gomora
Mama sizo sheba ngani?
Ntwana yase kasi sekumelе uyophanda
Bathi ntwana yase kasi sekumelе uyophanda
Ntwana yase kasi sekumele uyophanda
Bathi ntwana yase kasi sekumele uyophanda
Ishuu awuthi ngiyiphinde
Bathi khule nabantu badala badlu mtlabathi
Umama uqedu thum' umbali ayothenga inkomasi
Ekhaya kuse gomora mama sizo sheba ngani
Ntwana yase kasi sekumele uyophanda bathi ntwana yase kasi sekumele uyophanda
Ntwana yase kasi sekumele uyophanda bathi ntwana yase kasi sekumele uyophanda
Ishuu nantsoke sesfikile

Mhhh sesfike ngama waza waza waa hayayaa
Ehhhh yey amawazawaza amawazawaza amawazawaza mhhh yeyeee
...
Mhhh sesfike ngama waza waza waa hayayaa
Ehhhh yey amawazawaza amawazawaza amawazawaza mhhh yeyeee` },
  { id: 'builtin_84', title: `Ngixolele`, artist: `Busta 929 feat. Boohle`, album: null, lyrics: `[Intro]
Mmhhhhhhmmm!
Yhi yhi yiii...
Ase trap ke pina tsako kasi
...
[Verse]
Ngixolele
Ngixolele ububi bami
Ngixolele izono zami
Bengingazi
Ngixolele
Ngixolele ububi bami
Ngixolele izono zami
...
Ay Busta ung’kestsang` },
  { id: 'builtin_85', title: `Mutual Core`, artist: `Bjork`, album: null, lyrics: `[Verse 1]
...
This eruption undoes stagnation
You didn't know, you didn't know` },
  { id: 'builtin_86', title: `Taste In Movies`, artist: `Mr. Twin Sister`, album: null, lyrics: `Tell me I'm desensitized
...
Not so naïve
To expect my touch to mirror` },
  { id: 'builtin_87', title: `Pressha`, artist: `Jill Scott - Pressha`, album: null, lyrics: `[Intro]
Yeah
Oh-oh-oh
...
Love moves swiftly, we graduated
And intensely showed us, no need to fake it

[Chorus]
I wasn't the aesthetic (I guess)
I guess, I guess I get it
So much pressure to appear just like them (Just like them)
I find it so pathetic (You)
...
[Verse 3]
You're like the wolf outside my bedroom door
Howling at the moon for me
Craving all my tasty love (Tasty love)
Now you got plenty money, plenty fame
I know you're out there smiling for the world
And thinking my name (Jill Scott)
...
Just like them (Just like them)
So much pressure` },
  { id: 'builtin_88', title: `Lighthouse`, artist: `Jill Scott`, album: null, lyrics: `[Verse 1]
I know, oh, I know
...
Tornado, lightning, hurricane
Can't get by me
Come under my glow (Whatever trouble)
Feel the energy, let go
Lay your burdens down (Lay your burdens down)
I am your shelter
...
I need
Sitting here, contemplating` },
  { id: 'builtin_89', title: `Rock With U`, artist: `Janet Jackson`, album: null, lyrics: `[Intro]
(I want to rock with you)
I wanna rock with you
Just once
(I want to rock with you) Come on
...
[Verse 2]
Strobe lights make everything (Strobe lights)
Sexier (So sexy)
Shadows dancing on the wall (Do you see me?)
I wanna rock with you
Let's converse (Can we talk?)
Talk with your body, don't say anything at all (Shhh)
(I want to rock with you)
...
[Verse 3]
(Uh)
Strobe lights make everything (Everything)
Sexier (So sexy)
Shadows dancing on the wall (Our bodies as one)
...
Rock with you
Ooh-ooh-ooh, ooh, ooh` },
  { id: 'builtin_90', title: `To Zion`, artist: `Lauryn Hill feat. Carlos Santana`, album: null, lyrics: `[Intro]
...
[Class]
(Laughter)` },
  { id: 'builtin_91', title: `Space`, artist: `Elestee & Ajebo Hustlers`, album: null, lyrics: `[Intro]
[?]

[Chorus: Elestee]
Said I keep it on me like a militant
Rough up anybody wey no give me my way
Open sesame say make them give me chance
Vava-vava voom make them give me my space
Gimme my, gimme my
Gimme my, gimme my space
Gimme my, gimme my
Vava-vava voom make them give me my space
Gimme my
...
After money talk we knack the kpoli
I′m serious bout my business and you know this
Speeding past the vet likе what a novice
Richer than my ancestors, I'm focusеd
I′ll never get below this
Higher, higher right until die, I'll keep on floating
Gravity don't know me so she sure as hell can′t hold me
Sure as hell can′t hold me
Standing on my business never folding
Give it up for me and all this motion

[Chorus: Elestee]
Keep it on me like a militant
Rough up anybody wey no give me my way
Open sesame say make them give me chance
Vava-vava voom make them give me my space
Gimme my
...
[Verse 2: Piego]
Comot for road o, biko puor nuzor lo lo
Make I no go konk your moro-moro your scodo
The thing you talk o, you go back am up olo
You know my men dem mount osakpolo and igodo
Oganigwe, oganigwe, oganigwe le
Ngbenine my men dem ruth out them go jewe
Aye po gan omo plenty space dey
No go leke, leke, leke for our terrain
Oganigwe, oganigwe, oganigwe le
Ngbenine my men dem ruth out them go jewe
Aye po gan omo plenty space dey
No go leke, leke, leke for our terrain

[Chorus: Elestee, Piego & Knowledge]
Keep it on me like a militant (Oh, no, no, no, no)
Rough up anybody wey no give me my way (Hey)
Open sesame say make them give me chance (Comot body, eish)
Vava-vava voom make them give me my space (Hey, kpos)
Gimme my

[Verse 3: Knowledge]
Tell them make them jazz up
Throw way salama before them lap us
All these mango tree wey dey play catch up
Match anybody wey dey baff up (Match am)
If I dread your sheriff abobbi forget about before we knack shot
No go dey, no go dey price market wey you no fit buy
Me I no fit lie see manchi wey I no fit sly
When e reach to keep am 100 me I no see skye
I dey fight for my life abruh my spirit no fit die (At all)
Moving like a militant
Nobody goes, nobody fox like Vivica
Biko Oginikwa my cigar no get filiter
Before we get spiritual
Tell them make them give me my space or we go get physical
...
Vava-vava voom make them give me my space
Gimme my` },
  { id: 'builtin_92', title: `Dákiti`, artist: `Bad Bunny JHAYCO`, album: null, lyrics: `[Letra de "DÁKITI"]
...
Si no te ha' venío', yo te vo'a esperar
En mi cama y lo vo'a celebrar` },
  { id: 'builtin_93', title: `Tokyo`, artist: `Lianne La Havas`, album: null, lyrics: `[Verse 1]
I am neon
Cold neon
Not a mystery
...
(You're out of my reach, wrong place, wrong time)` },
  { id: 'builtin_94', title: `Moment`, artist: `Victoria Monét`, album: null, lyrics: `[Verse 1]
...
This your motherfuckin' moment` },
  { id: 'builtin_95', title: `I Love This Feeling`, artist: `Nas`, album: null, lyrics: `[Intro]
I'm gonna love you all through the morning
I'm gonna love you all through the morning
Yeah, see I'm goin' where I been, know how you feel
I'm gonna love you all through the morning
I'm gonna love you all through the morning
...
Yeah, I love this feeling` },
  { id: 'builtin_96', title: `Space Invader`, artist: `Kaytranada`, album: null, lyrics: `[Intro]
Oh-oh-oh, oh-oh-oh
Oh-oh-oh, oh-oh-oh
...
Gotta get away sometimes
Gotta get away sometimes
Gotta get away sometimes (Wanna get away)
Gotta get away sometimes
Gotta get away some—
Gotta gеt aw—
...
Oh-oh-oh, oh-oh-oh
Oh-oh-oh, oh-oh-oh` },
  { id: 'builtin_97', title: `Can’t Decide`, artist: `Max Dean, Luke Dean, & Locky`, album: null, lyrics: `verse
...
I′ll be, I'll be heading up in a while
I′m chillin' lowkey
Catch me on the downside
I′ll be, I'll be heading up in a while
I'm chillin′ lowkey
...
′Cause boy, your love is like a drug` },
  { id: 'builtin_98', title: `86Sentra`, artist: `NxWorries`, album: null, lyrics: `[Verse: Anderson .Paak]
Nigga, it's the top-five lister, double-S drifter
...
We survived shit you can only catch a whiff of (Whew)
Locked in way before the top ten
When I had the mutton chops, shades, and the wide brim
On a diffеrent wave that I came in thе game on
...
If it's locked in, it's gotta be Knxwledge who made it
...
Compliments of Knxwledge and the motherfuckin' yes, Lord
And we can go toe-to-toe, anyone you know, young or old'll get drove in the hearses
I just did the Super Bowl halftime show with the GOATs, why the fuck would I wanna do a Verzuz?
That's like comparin' tee-ball to the MLB, y'all out of your league, we not the same person
I'll be doin' this 'til I'm 'bout eighty-six, old as a bitch, holdin' my dick, fuckin' on the nurses` },
  { id: 'builtin_99', title: `Almeda`, artist: `Solange`, album: null, lyrics: `[Intro: Metro Boomin]
Hol' up

[Verse 1: Solange & Metro Boomin]
Pour my drank, drank
Sip, sip, sip, sip, sip
Pull that 'Lac on 'em (Hol' up)
Sip, sip, sip, sip, sip
Brown liquor, brown liquor
Brown skin, brown face
Brown leather, brown sugar (Hol' up)
Brown leaves, brown keys
Brown clippers, brown face
...
Not even in that Florida water (Hol' up)
In that Florida water
So pour more drank
Sip, sip, sip, sip, sip, sip
I pour my drank on 'em
Sip, sip, sip, sip, sip (Hol' up)
Brown liquor
...
[Refrain: The-Dream, Playboi Carti & Metro Boomin]
Just sittin' here foolin' around (What?)
We just sittin' here coolin' around (What?)
We just sittin' here high, comin' down (Hol' up)
...
Smokin' that dope, that that skunk
I get that chopper, that dump, yeah
All of my diamonds, they lumps, ooh
All of my diamonds, big lumps, ooh
I get that cash, got a bunch, ooh
I'ma die lit, bitch, I promise, yeah (Hol' up)
Tear the bitch up, break her heart
Young nigga fresh from the start (Hol' up)
Young nigga fresh from the start (Hol' up)
Bad-ass bitch from the start (Hol' up)
Young nigga fresh from the start (Hol' up)
...
They takin' me in, what I done? (What?)` },
  { id: 'builtin_100', title: `Q.U.E.E.N`, artist: `Janelle Monae`, album: null, lyrics: `[Intro: Janelle Monáe]
...
Or will you preach?` },
  { id: 'builtin_101', title: `Lady Lady`, artist: `Olivia Dean`, album: null, lyrics: `[Verse 1]
...
Her, her
That lady, lady, she's the—` },
  { id: 'builtin_102', title: `Never Ending`, artist: `Rihanna`, album: null, lyrics: `[Intro]
Ooh
Oh
...
Why does it have to feel so strange
To be in love again, be in love again, be in love again?` },
  { id: 'builtin_103', title: `All That I Can Say`, artist: `Mary J. Blige & Lauryn Hill`, album: null, lyrics: `[Verse 1]
...
(Doo-doo, doo-doo, doo-doo-doo)
(Doo-doo, doo-doo, doo-doo-doo)` },
  { id: 'builtin_104', title: `Heart of a Woman`, artist: `Summer Walker`, album: null, lyrics: `[Chorus]
...
Is the heart of a woman (Ah-ah)` },
  { id: 'builtin_105', title: `Living For The City`, artist: `Stevie Wonder`, album: null, lyrics: `[Verse 1]
...
Lo lo, lo lo
Lo lo` },
  { id: 'builtin_106', title: `Dreamer`, artist: `Women in Jazz & MADELEINE`, album: null, lyrics: `[Verse 1]
My heart, it breaks for them
My heart, it breaks for them
My heart, it breaks for them
Innocent lives, lies we turn away from
Find shelter from their gun
My heart, it prays for them
My heart, it bleeds for them
My heart, I bleed for them
I see their faces in the water
They could've been your daughter

[Chorus]
Dreamer
Dreamer
We must find hope through times of war
Survive like we did before

[Verse 2]
Voices, thеy tried to shout, they
They triеd to scream
What does it mean like me?
They tried to find safe places
This war made them nameless
Survivor through the night, they
They tried to fight in system denied
They fly, find loving in a stranger
Accustomed to the danger

[Chorus]
Dreamer
Dreamer
We could find love in times of war
Survive like we did before
...
We could rest, it’s warmer there
I will comfort you, yeah
...
Survive
Like we did before` },
  { id: 'builtin_107', title: `99 Luftballoons`, artist: `Kaleida / Nena`, album: null, lyrics: `[Strophe 1]
...
Denk' an dich und lass' ihn fliegen` },
  { id: 'builtin_108', title: `Deathwish`, artist: `akiaura, LONOWN & Baby Jane`, album: null, lyrics: `[Chorus]
Pretty young boy with a death wish
Got your mother's eyes and stardust on your lips
...
[Outro]
See in you` },
  { id: 'builtin_109', title: `Oh Happy Day`, artist: `Sister Act 2 Cast`, album: null, lyrics: `Oh happy day (oh happy day)
...
Oh, oh, oh
Oh happy day!` },
  { id: 'builtin_110', title: `Joy To the World`, artist: `Traditional`, album: null, lyrics: `Intro
Verse 1
...
And wonders, wonders, of His love.` },
  { id: 'builtin_111', title: `O Come All Ye Faithful`, artist: `Tomlin Version`, album: null, lyrics: `Verse 1
...
We’ll praise your Name forever
Christ the Lord` },
  { id: 'builtin_112', title: `O Holy Night`, artist: `Kim Walker-Smith`, album: null, lyrics: `Verse 1
O holy night, the stars are brightly shining
It is the night of our dear Savior’s birth
Long lay the world in sin and error pining
Til He ap- peared and the soul felt its worth
A thrill of hope, the weary world re – joic – es
For yonder breaks a new and glorious morn
Chorus 1
Fall on your knees
O hear the angel voic – es, O night di – vine
O night when Christ was born
O night di – vine
O night, O night, di – vine
Verse 2
Truly He taught us to love one a – nother
...
O night di – vine
O night, O night, di – vine` },
  { id: 'builtin_113', title: `Silent Night`, artist: `Traditional`, album: null, lyrics: `Intro
...
Christ the Savior is bo - rn
Christ the Savior is born` },
  { id: 'builtin_114', title: `Firm Foundation (He Won't)`, artist: `Austin Davis, Chandler Moore, and Cody Carnes`, album: null, lyrics: `Chorus 1
...
He won't fail no He won't` },
  { id: 'builtin_115', title: `Breathe`, artist: `Maverick City Music`, album: null, lyrics: `Verse 1
...
Beating, breathing
In oxygen` },
  { id: 'builtin_116', title: `Moving`, artist: `TRIBL`, album: null, lyrics: `Mm, this fresh wind, we don't wanna miss it
Mm

Awake, O sleeper, open your eyes and see
Just look around you, He's shifting everything
He is moving
My God is moving
Awake, awake, O sleeper, open your eyes and see
(Just look around) Just look around you, He's shifting everything
He is moving
Oh, my God is moving

(He's doing) He's doing something new, can't you see?
He's doing something new and it's with you and me
He's making something new, it's history
He's making history

He takes the foolish, makes it confound the wise
He took this dead man and raised him back to life
He is moving
Oh, my God is moving (Oh)

He's doing something new, can't you see?
He's doing something new and it's with you and me
He's making something new, it's history
He's making history
He's doing something new, can't you see?
...
He's moving right now, oh

Streams in the desertland
Turn into rivers
Oh, Holy Spirit
Invade this place
